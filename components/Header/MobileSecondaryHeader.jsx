...
const MobileSecondaryHeader = ({session,categories,dictionary,lang}) => {
  return (
    <div className="bg-secondary text-secondary-foreground fixed w-full left-0 bottom-0 z-50 block md:hidden">
      <div className="flex gap-2 justify-between items-center h-20 px-2">
        ...
        <CartIcon session={session} lang={lang} className="flex flex-col justify-center items-center h-full p-2  text-sm" showTitle={true} />
